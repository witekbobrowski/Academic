...
function displayRegisterInfo(register) {
    getConnection((err, connection) => {
        ...
        connection.query('SELECT * FROM attendance INNER JOIN students WHERE class_ID = (SELECT class_ID FROM classes WHERE class_ID = ?) ORDER BY students.lastName;', [register], (error, rows, fields) => {
            if (error) throw error;
